...
def get_receiver():
    return ppmReader.get_values()

def check_arm(channel):
...
while True:
    ...
    armed = check_arm(channels[4])

    print("===========================================")
    for i in range(len(channels)):
        print("channel ", i, ":", channels[i])

# channel 0: 1: left 0: right
# channel 1: 0: backward 1: forward
# channel 2: 0: down 1: up
# channel 3: 0: rotate right 1: rotate left
# channel 4: 0: armed 1: disarmed